...
func (*UserInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_31eda07259c54a37, []int{0}
}
...
func (*UserInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_31eda07259c54a37, []int{1}
}
...
func init() {
	proto.RegisterType((*UserInfoRequest)(nil), "pb.resource.v1.UserInfoRequest")
	proto.RegisterType((*UserInfoResponse)(nil), "pb.resource.v1.UserInfoResponse")
}

func init() { proto.RegisterFile("pb/resource.proto", fileDescriptor_31eda07259c54a37) }

var fileDescriptor_31eda07259c54a37 = []byte{
	// 150 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *resourceClient) UserInfo(ctx context.Context, in *UserInfoRequest, opts ...grpc.CallOption) (*UserInfoResponse, error) {
	out := new(UserInfoResponse)
	err := c.cc.Invoke(ctx, "/pb.resource.v1.Resource/UserInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedResourceServer) UserInfo(ctx context.Context, req *UserInfoRequest) (*UserInfoResponse, error) {
...
func _Resource_UserInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ResourceServer).UserInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.resource.v1.Resource/UserInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ResourceServer).UserInfo(ctx, req.(*UserInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Resource_serviceDesc = grpc.ServiceDesc{
	ServiceName: "pb.resource.v1.Resource",
	HandlerType: (*ResourceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "UserInfo",
			Handler:    _Resource_UserInfo_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pb/resource.proto",
}
